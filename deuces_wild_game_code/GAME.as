...
package
{
	...
	public class GAME extends DISPLAY
	{
		...
		private function Asset_Loader_Handler(ratio:Number):void
		{
			...
			Add_Children([Background_Image, Card1, Card2, Card3, Card4, Card5, Deal_Button, Current_Bet_Text, Exit, Bet_Max, Bet, Bet_Less, Total_Area, Paytable1]);
		...
		//only performs its action if you are in the first case, represented by being able to hold cards and if the current bet is larger than 1, removing the possibility for 0 or negative bets
		//removes the old payout tables
		...
		//The first occurring win will break the check, awarding the highest possible payout for the current hand. This simplifies the win class since we can disregard some cases for the lower hands.
